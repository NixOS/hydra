...
__PACKAGE__->has_many("builds", "Hydra::Schema::Result::Builds", { "foreign.jobset_id" => "self.id" }, undef,);
...
__PACKAGE__->has_many("jobsetevals", "Hydra::Schema::Result::JobsetEvals", { "foreign.jobset_id" => "self.id" },
    undef,);
...
__PACKAGE__->has_many(
    ...
    { "foreign.project" => "self.project", "foreign.to_" => "self.name" }, undef,
);
