...
ok(evalSucceeds($ctx{context}, $jobset), "Evaluating jobs/build-output-as-input.nix should exit with return code 0");
...
ok(evalSucceeds($ctx{context}, $jobset), "Evaluating jobs/build-output-as-input.nix for second time should exit with return code 0");
