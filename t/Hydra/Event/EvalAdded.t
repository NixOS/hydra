...
subtest "Parsing eval_added" => sub {
    like(dies { Hydra::Event::parse_payload("eval_added", "") },               qr/three arguments/, "empty payload");
    like(dies { Hydra::Event::parse_payload("eval_added", "abc123") },         qr/three arguments/, "one argument");
    like(dies { Hydra::Event::parse_payload("eval_added", "abc123\tabc123") }, qr/three arguments/, "two arguments");
    like(
    ...
    is(Hydra::Event::parse_payload("eval_added", "abc123\t123\t456"), Hydra::Event::EvalAdded->new("abc123", 123, 456));
};
