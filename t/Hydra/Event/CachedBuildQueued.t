...
subtest "Parsing" => sub {
    like(dies { Hydra::Event::parse_payload("cached_build_queued", "") }, qr/takes two arguments/, "empty payload");
    like(
...
subtest "load" => sub {
    ...
    is($passedEvaluation->id, $evaluation->id,
        "The plugin's cachedBuildQueued hook is called with a matching evaluation");
