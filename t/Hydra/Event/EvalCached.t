...
subtest "Parsing eval_cached" => sub {
    like(dies { Hydra::Event::parse_payload("eval_cached", "") },               qr/three arguments/, "empty payload");
    like(dies { Hydra::Event::parse_payload("eval_cached", "abc123") },         qr/three arguments/, "one argument");
    like(dies { Hydra::Event::parse_payload("eval_cached", "abc123\tabc123") }, qr/three arguments/, "two arguments");
    like(
    ...
    is(Hydra::Event::parse_payload("eval_cached", "abc123\t123\t456"),
